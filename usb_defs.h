...
#define EP0_PACKET_SIZE		8	// maximum packet size for low-speed peripherals is 8 bytes, for full-speed peripherals it can be 8, 16, 32, or 64 bytes
...
far unsigned char EP0_OUT_buffer[EP0_PACKET_SIZE];
far unsigned char EP0_IN_buffer[EP0_PACKET_SIZE];
far unsigned char EP1_IN_buffer[EP1_PACKET_SIZE];
